...
<div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto " id="kt_brand">
        ...
        <a href="/dashboard" class="brand-logo" style="text-decoration: none;">
            <h3 class="text-white font-weight-bolder mb-0" style="letter-spacing: 0.5px; font-size: 1.25rem;">KEUANGAN KKN</h3>
        </a>
            ...
            <ul class="menu-nav ">
                ...
                <li class="menu-item {{ request()->routeIs('dashboard') ? 'menu-item-active' : '' }}"
                    ...
                    <a href="{{ route('dashboard') }}" class="menu-link">
                        ...
                        <span class="menu-text">Dasbor</span></a>
                </li>
                ...
                <li class="menu-item {{ request()->routeIs('wallets.*') ? 'menu-item-active' : '' }}"
                    ...
                    <a href="{{ route('wallets.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">Buku Kas</span>
                    </a>
                </li>
                ...
                <li class="menu-item {{ request()->routeIs('budgets.*') ? 'menu-item-active' : '' }}"
                    ...
                    <a href="{{ route('budgets.index') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!-- Fixed SVG for Budgets -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                                version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                                    <path
                                        d="M4,4 L11.6314229,2.5691176 C11.9753854,2.50032516 12.3587346,2.69348937 12.5613322,3.01353246 C13.0617616,3.803732 13.7291684,4.402263 14.5,4.787 C15.426,5.25 16.5,5.25 17.5,5.25 C18.5,5.25 19.574,5.25 20.5,4.787 C21.426,4.324 22,3.324 22,2.25 L22,17.25 C22,18.324 21.426,19.324 20.5,19.787 C19.574,20.25 18.5,20.25 17.5,20.25 C16.5,20.25 15.426,20.25 14.5,19.787 C13.574,19.324 13,18.324 13,17.25 L13,10.25 C13,9.75 12.79,9.25 12.44,8.875 C12.09,8.5 11.59,8.25 11.06,8.25 L4,8.25 C3.44771525,8.25 3,7.80228475 3,7.25 L3,4.75 C3,4.33578644 3.33578644,4 3.75,4 L4,4 Z"
                                        fill="#000000" opacity="0.3" />
                                    <path
                                        d="M11.06,10.25 L4,10.25 C3.44771525,10.25 3,10.6977153 3,11.25 L3,19.75 C3,20.3022847 3.44771525,20.75 4,20.75 C4.55228475,20.75 5,20.3022847 5,19.75 L5,12.25 L11.06,12.25 C11.59,12.25 12.09,12.5 12.44,12.875 C12.79,13.25 13,13.75 13,14.25 L13,17.25 C13,18.324 13.574,19.324 14.5,19.787 C15.426,20.25 16.5,20.25 17.5,20.25 C18.5,20.25 19.574,20.25 20.5,19.787 C21.426,19.324 22,18.324 22,17.25 L22,14.25 C22,13.176 21.426,12.176 20.5,11.713 C19.574,11.25 18.5,11.25 17.5,11.25 C16.5,11.25 15.426,11.25 14.5,11.713 C13.7291684,12.097737 13.0617616,12.696268 12.5613322,13.4864675 C12.3587346,13.8065106 11.9753854,14.0003252 11.6314229,13.9308824 L4,12.5 Z"
                                        fill="#000000" />
                                </g>
                            </svg>
                        </span>
                ...
                <li class="menu-item {{ request()->routeIs('debts.*') ? 'menu-item-active' : '' }}"
                    ...
                    <a href="{{ route('debts.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">Utang & Piutang</span>
                    </a>
                </li>
                ...
                <li class="menu-item {{ request()->routeIs('transfers.*') ? 'menu-item-active' : '' }}"
                    ...
                    <a href="{{ route('transfers.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">Mutasi Kas</span>
                    </a>
                </li>
