        ...
        <div class="card card-custom gutter-b">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Ubah Limit for {{ $budget->category }}</h3>
                </div>
            </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control form-control-solid" value="{{ $budget->category }}"
                                disabled />
                            <span class="form-text text-muted">Category cannot be changed. Hapus and re-create if
                                needed.</span>
                        </div>
                        <div class="col-lg-6">
